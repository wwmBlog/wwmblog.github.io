...
j.val()||j.val()==j.attr("placeholder"))l.html("\u4f60\u4ec0\u4e48\u90fd\u8fd8\u6ca1\u5199\u5462~~");else if(r(n.val()))if(lastMailContent==j.val())l.html("\u4f60\u5df2\u7ecf\u53d1\u8fc7\u4e00\u6837\u7684\u6d88\u606f\u4e86\u3002");else{lastMailContent=j.val();l.html("");s(e[2]);l.html("Sending...");$.ajax({type:"POST",url:"ohnewmessage.php",data:{email:n.val(),content:j.val()},success:function(b){"Success"==b?(l.html("\u53d1\u9001\u6210\u529f\u3002\u6211\u4f1a\u5c3d\u5feb\u56de\u590d\u4f60\u7684\u3002"),
